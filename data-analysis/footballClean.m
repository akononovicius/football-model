...
[engData.gameId, engData.dateString, engData.season, engData.homeTeam, ...
 engData.awayTeam, engData.ftString, engData.homeGoals, engData.awayGoals, ...
 engData.divisionString, engData.tier, engData.totalGoals, engData.goalDiff, ...
 engData.resultString] = textread('england.csv',...
                                  '%d %s %d %s %s %s %d %d %s %d %d %d %s', ...
                                  'delimiter',',','headerlines',1);
                                  
% Lets now remove irrelevant fields (columns).
engData = rmfield(engData,{'gameId' 'ftString' 'divisionString' ...
